        ...
        <footer className="footer">
            <div className="container footer__container">
                <a className="footer__logo-link">
                    <img src="image/logo.svg" alt="Логотип CUP TIME" className="footer logo" />
                </a>
                ...
                <div className="footer__info">
                    ...
                    <p className="footer__discription">Проект сделан в учебных целях</p>

                    <ul className="footer__developers">
                        <li className="footer__developer">Designer: <a href="#" className="footer__developer-link">Anastasia
                            Ilina</a></li>
                        <li className="footer__developer">Developer: <a href="#" className="footer__developer-link">Alexander
                            Troyan</a></li>
                    </ul>
                </div>
                ...
                <div className="footer__contacts">
                    ...
                    <ul className="footer__social">
                        <li className="footer__social-item">
                            <a href="#" className="footer__social-link"><svg width="32" height="32" viewBox="0 0 32 32"
